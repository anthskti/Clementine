...
export const CLEMENTINE_ACTIONS: Record<string, string> = {
  healthy_flower: "/assets/photos/clementine_watering.png",
  wilting: "/assets/photos/clementine_shearing.png",
  weed: "/assets/photos/clementine_shovel.png",
  time_to_trim: "/assets/photos/clementine_shearing.png",
  overwatered: "/assets/photos/clementine_watering.png",
  dead: "/assets/photos/clementine_shovel.png",
};
